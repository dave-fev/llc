      ...
      <div className="min-h-screen flex">
        ...
        <div className="w-full lg:w-13/24 flex items-center justify-center p-6 sm:p-8 lg:p-12 bg-gradient-to-br from-neutral-50 via-white to-neutral-50 relative">
          ...
          >
            ...
            <span className="text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">Back to Home</span>
          </Link>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl font-black text-neutral-900 mb-2">Sign In</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center cursor-pointer group">
                    <input
                      type="checkbox"
                      className="w-4 h-4 text-neutral-900 border-2 border-neutral-300 rounded focus:ring-2 focus:ring-neutral-900 focus:ring-offset-0 cursor-pointer"
                    />
                    <span className="ml-2 text-sm font-medium text-neutral-700 group-hover:text-neutral-900">Remember me</span>
                  </label>
                  <Link
                ...
                <div className="text-center pt-4">
                  <p className="text-sm text-neutral-600">
                    ...
                    <Link href="/form" className="font-bold text-neutral-900 hover:text-neutral-700 transition-colors">
                      Start Your LLC
                    </Link>
                  </p>
                </div>
